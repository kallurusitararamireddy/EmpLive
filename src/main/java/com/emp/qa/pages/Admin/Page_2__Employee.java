...
public class Page_2__Employee extends BasePage {
	...
	public void Register_Employee() throws InterruptedException, AWTException {
		...
		String Act_g = "Autiomation";

		helper.waitFor(Firstname);
		helper.highLightElement(driver, Firstname);
		Firstname.click();
		Firstname.sendKeys(Act_g + helper.randomChar());
		Reporter.log(
		...
		int num1 = g1.nextInt(100);
		String Act_g1 = "skabcdef";
		String Exp_g = Act_g1 + num1;
		...
		Random r = new Random();
		int num11 = r.nextInt(100);
		String Act_code = "Emp-Abzcde-12345";
		String Exp_code = Act_code + num11;
		...
		Thread.sleep(1000);
		helper.selectDropDownValue(Location, "visibletext", "Banglore");
...
//		helper.move_to_element(Department);
		helper.selectDropDownValue(Department, "value", "Node js");
...
//		helper.selectDropDownValue(selectshift, "value", "475");
	...
	@FindBy(xpath = "/html/body/div[1]/div/div[7]/form[11]/div/div/div/div[2]/div[1]/select/option[5]")
...
//		helper.move_to_element_click(SelectRole_dropdown_list);
//		helper.jsCLick(SelectRole_dropdown_list);
//		helper.selectDropDownValue(SelectRole_dropdown_list, "value", "Manager");
		helper.SelectDropdownValue(SelectRole_dropdown_list, "Manager");
...
//	Assert.assertTrue(true, "Failed to Click on Video-quality Drop-down and Selected Any Value");
	...
	public void TrackUserSettings() throws InterruptedException {
		...
		helper.selectDropDownValue(SettingsAppliedTotheuser_at, "value", "1");
...
//	helper.selectDropDownValue(WhichRole, "value", "230");
	...
	public void BulkUpdate() throws InterruptedException, AWTException {
		...
		helper.uploadFile("C:\\Live_Site_EMP_PR\\Live_site_Emp_Monitor\\screenshots\\Employee list.xlsx");
		Thread.sleep(3000);

		helper.waitFor(Update_Button_B);
		helper.highLightElement(driver, Update_Button_B);
		helper.jsCLick(Update_Button_B);
